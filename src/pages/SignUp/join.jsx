...
const JoinForm = () => {
    ...
    const handleOnSubmit = (e) => {
        ...
        if (!checkUsername && !checkMatKhau && !validated && !checkEmail) {
            // Thêm email vào formData trước khi gửi
            const dataToSubmit = {
                ...formData,
                email: email.email, // Gán email vào dữ liệu đăng ký
            };
            // console.log(dataToSubmit);
            // Gọi API đăng ký
            callRegisterRefetch(dataToSubmit);
        }
    }
    ...
    useEffect(() => {
        if (RegisterResponse) {
            ...
            if (RegisterResponse.success) {
              ...
              if (RegisterResponse.message === "Tài khoản đã tồn tại") {
                alert("Người dùng đã tồn tại! Vui lòng chọn người dùng khác.");
              } else if (RegisterResponse.message === "Email đã tồn tại") {
        ...
        <div className='background-DangKy'>
            <div className='signin-layout'>
                <Form onSubmit={handleOnSubmit}>
                    <h3 style={{ color: 'white' }}>Đăng ký Pjob</h3>
